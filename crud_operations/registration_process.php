...
$sql1 = "INSERT INTO users(user_email, user_password) VALUES ('$user_email','$user_pass')";
mysqli_query($conn, $sql1);

$sql2 = "SELECT * FROM users WHERE user_email = '$user_email' AND user_password = '$user_pass'";
